  ...
  const deleteHandler = async (id) => {
    ...
    if (result.isConfirmed) {
      ...
      try {
        ...
        setAllCategories((prev) => prev.filter((item) => item._id !== id));
      } catch (error) {
        console.error(error);
        error.message ? toast.error(error.message, { className: "toastify" }) : null;
        setLoading(false);
              ...
              <div className="card-body p-4">
                <div className="row h-100">
                  <div className="d-flex justify-content-between">
                    <h3 className="card-heading font-color fs-4 text-uppercase">Categories</h3>
                    <div
                      onClick={() => {
                  ...
                  <p className="card-text font-color fs-6">Find all your categories below. Manage them as needed.</p>
                      ...
                      <table className="order-table w-100">
                        ...
                        <tbody className="font-color fs-6">
                          {allCategories.map((category, index) => (
                            <tr className="border-bottom border-warning border-opacity-10" key={category._id}>
                              ...
                              <td>
                                <Link to={`/admin/category/${category._id}`} className="text-decoration-none me-3">
                                  <svg
                                    width="30px"
                                    height="30px"
                                    viewBox="0 -0.5 25 25"
                                ...
                                <Link onClick={() => deleteHandler(category._id)} className="text-decoration-none">
