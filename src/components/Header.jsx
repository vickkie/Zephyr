            ...
            <ul className="navbar-nav col-sm-4 font-color justify-content-end">
              {
                ...
                !isAuthenticated ? (
                  <Link
                    to="/login"
                    id="login"
                    className="btn nav-link font-color bg-color px-4 py-2 mx-2 text-uppercase"
        ...
        <div className="collapse navbar-collapse row m-0 navbarNav" id="navbarNav">
          <ul className="navbar-nav col-sm-12 justify-content-center">
            <li className="nav-item">
              <NavLink className="nav-link font-color bg-color px-4 py-0 mx-2 text-center" id="index" to="/">
                Home
              </NavLink>
            </li>
            <li className="nav-item">
              <NavLink className="nav-link font-color bg-color px-4 py-0 mx-2 text-center" id="shop" to="/shop">
                Shop
              </NavLink>
            </li>
            {/* <li className="nav-item">
            ...
            <li className="nav-item dropdown dropdown-hover">
              <NavLink
                className="nav-link dropdown-toggle font-color bg-color px-4 py-0 mx-2 text-center"
                to="/women"
                role="button"
            ...
            <li className="nav-item">
              <NavLink className="nav-link font-color bg-color px-4 py-0 mx-2 text-center" id="kids" to="/kids">
                Kids
              </NavLink>
            </li>
            <li className="nav-item">
              <NavLink className="nav-link font-color bg-color px-4 py-0 mx-2 text-center" id="contact" to="/contact">
                Contact
              </NavLink>
            </li>
          </ul>
