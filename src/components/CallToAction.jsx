    ...
    <section className="call-to-action container-fluid mt-3">
      <div className="row p-lg-5 p-4">
        <div className="col-md-9">
          <p className="product-card-price text-uppercase m-0">Shop</p>
          <h3 className="card-heading lg-font display-2 fw-normal lh-1">LET&rsquo;S MAKE YOUR FASHION SHINE</h3>
        </div>
